class argHandler(dict):
    ...
    def setDefaults(self):
        self.define('config', './darkflow/build', 'path to .cfg directory')
        ...
        self.define('pbLoad', './darkflow/build/yolo-obj.pb', 'path to .pb protobuf file (metaLoad must also be specified)')
        self.define('metaLoad', './darkflow/build/yolo-obj.meta', 'path to .meta file generated during --savepb that corresponds to .pb file')
